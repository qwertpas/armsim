...
public class Motor{
    ...
    public final double MAX_VOLTAGE = 12;
    ...
    public void setPower(double power){
        ...
        voltage = power * MAX_VOLTAGE; //assumes that robot system voltage is always at max (no brownout)
    }
    ...
    public void update(double radPerSec_input, double dt){
        ...
        torque = motorType.STALL_TORQUE * ((voltage / MAX_VOLTAGE) - (angVelo / motorType.FREE_SPEED));
